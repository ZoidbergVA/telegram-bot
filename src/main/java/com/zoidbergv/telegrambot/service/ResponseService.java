...
public class ResponseService {
	...
	public void init() {
		...
		this.responses.add(new Response(1,
				"Lei non si e mai comportato in quel modo o solo molto raramente (dallo 0 al 10% delle volte)."));
		...
		this.responses
				.add(new Response(4, "Lei si comporta in quel modo sempre o quasi sempre (90-100% delle volte)."));
	}
